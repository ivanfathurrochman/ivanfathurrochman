...
Tugas 2
Buat program untuk mengurutkan data berdasarkan input sejumlah data (minimal 3 variable input atau lebih), kemudian tampilkan hasilnya secara berurutan mulai dari data terkecil. Gambar1
Tugas 3
Buat program dengan perulangan bertingkat (nested) for yang menghasilkan output sebagai berikut: Gambar1
Tugas 4
